...
const STEPS = [
  ...
  {
    title: '② AIに質問する',
    body: '詳細画面から「AIに聞く」を選ぶと、その語についてAIと対話できます。会話は自動では保存されません。ホーム画面の「取り込む」から単語帳に保存します。',
  },
  {
    title: '③ 別の端末とデータを揃える',
    body: 'メニュー（☰）の「連携」から、PCとAndroidを同じWi-Fiにつないでカメラで QRコードを読み取るだけで、AI補足を含む単語データを両方の端末で同じ状態にできます。',
  },
] as const;
