...
/**
 * 設定画面の「ローカルデータ」セクション（Android版）。docs/local-data.md の実装。
 * File System Access API 前提のため、Android（WebView）では isFolderSyncAvailable() が
 * false を返し「この環境では使えません」の案内だけを表示する（PC版と同じ分岐）。
 */
