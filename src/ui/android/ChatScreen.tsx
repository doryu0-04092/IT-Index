...
export interface ChatScreenProps {
   ...
   * 入力欄・クイック質問等の操作一式を隠し、会話を読むだけの画面にする（2026-08-06追加、PC版と同一）。
   */
  readOnly?: boolean;
}
...
export default function ChatScreen({
  ...
  // （PC版と同一）。APIキー未設定のうちは送らない——送ると失敗した発言だけがDBに残り、
  // キー入力後に回答の無いユーザー発言が宙に浮く。キーが入った時点で改めてこの効果が動く。
  ...
  // 話しているかは SubjectContext で確定しているため、文言に語名を埋め込む必要はない
